...
parser.add_argument('--gamma', type=float, default=None, help='Gamma for StepLR')
parser.add_argument('--warmup_ratio', type=float, default=None, help='Portion of training steps for warm up')
...
parser.add_argument('--log_user_metrics', type=bool, default=True, help="Log individual user metrics")
# evaluation #
...
parser.add_argument('--parts_time_vec', type=str, default=None, help='Which information to include from UNIX timestamp', nargs='*')
...
parser.add_argument('--mod_qt_dataset', type=str, default=None, choices=['val', 'test'], help='specify dataset for modification and evaluation')
